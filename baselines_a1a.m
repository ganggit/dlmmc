...
dataid = 'a1a';
fpath = '/Users/gangchen/Downloads/learning/study/new itml/itml/ML dataset/uci/ala/';
fname = 'train.mat';
load(fullfile(fpath, fname));
% X=da'; %  sonar [60 x 208]
% labels=la;
numdims = max(unique(pos));
numdata = size(ind,2);
X = zeros(numdims, numdata);
...
Accuracy{icolor} = evaluate_Acc(prelabel,nClusters,  option);
...
save([dataid '_result.mat'], 'Accuracy');
