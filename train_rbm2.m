function machine =train_rbm2(X, numhid, eta, maxepoch, weightcost)
...
% restart   -- set to 1 if learning starts from beginning 
    ...
    if ~exist('maxepoch', 'var') || isempty(max_iter)
        maxepoch = 100;        
    end
...
epsilonw      = eta;   % Learning rate for weights 
...
machine.W          = vishid;
machine.bias_upW   = hidbiases;
machine.bias_downW = visbiases;
