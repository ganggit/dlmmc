function [clusterLabel, W, CCCP_objFunVal, elapsedTime]=constrainedMMC_dbn_2(train_X,network, nClusters, lambda, cOne, T, option)
...
while( outterConvergence == 0 )
    ...
    [newW_vec, vWh, newObjFunVal, network] = extendedPEGASOS_dbn_2(train_X,network, nClusters,...
